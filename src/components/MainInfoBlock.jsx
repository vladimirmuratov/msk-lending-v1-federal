    ...
    return (
        ...
        >
            ...
            <Typography variant="h4" sx={{marginBottom: '20px', fontSize: {xs: '28px', sm: '34px'}, fontWeight: 500}}>
                Платная госпитализация в федеральные и ведомственные медучреждения: качество и комфорт на первом месте
            </Typography>
            ...
            <Typography component="p" sx={{fontSize: 20, marginBottom: '20px'}}>
                Выбирая платную госпитализацию в федеральные и ведомственные медицинские учреждения, вы получаете не
                только высокий уровень медицинской помощи, но и множество дополнительных преимуществ. Быстрый доступ к
                услугам без очередей, возможность выбрать лучших специалистов и современные диагностические и лечебные
                технологии. Мы обеспечим комфортное пребывание и индивидуальный подход к каждому пациенту, гарантируя
                вам качественное лечение и внимание, которое вы заслуживаете. Заботьтесь о своем здоровье с уверенностью
                в надежности и профессионализме.
                <br/>
                <br/>
